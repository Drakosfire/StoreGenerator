# This module will receive the json in the state, and process it from formatted into block-container blocks and page-container blocks, then return a json, with two lists, block-container, and page-container.
